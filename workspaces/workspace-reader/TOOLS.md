...
| 优先级 | 目录 | 用途 |
|:---:|:---|:---|
| 🥇 1 | `/home/gary/Obsidian/reader_books/Books/library_rag/{年份}/concepts/` | 书籍核心概念（JSON） |
| 🥈 2 | `/home/gary/Obsidian/reader_books/Books/library_rag/{年份}/chapters/` | 章节结构 |
| 🥉 3 | `/home/gary/Obsidian/reader_books/Books/library_rag/{年份}/quotes/` | 金句引用 |
| 4 | `/home/gary/Obsidian/reader_books/Books/library_rag/{年份}/metadata/` | 元数据 |
| 5 | `/home/gary/Obsidian/reader_books/Books/library/` | 本地笔记（补充） |
...
| `/home/gary/Obsidian/reader_books/Books/library/` | 书籍和笔记库 |
| `/home/gary/Obsidian/reader_books/Books/library_rag/` | RAG知识库（按年份：2023/2024/2025） |
| `/home/gary/Obsidian/reader_books/Books/library/books/` | 电子书存放 |
| `/home/gary/Obsidian/reader_books/Books/library/mindmaps/` | 思维导图/关系图 |
| `/home/gary/Obsidian/reader_books/Books/library/notes/` | 阅读笔记 |
| `/home/gary/Obsidian/reader_books/Books/library/quotes/` | 金句摘录 |
| `/home/gary/Obsidian/reader_books/Books/library/reviews/` | 书评存档 |
...
```bash
# 列出书籍目录
ls /home/gary/Obsidian/reader_books/Books/library/books/

# 列出已有笔记
ls /home/gary/Obsidian/reader_books/Books/library/notes/

# 列出思维导图
ls /home/gary/Obsidian/reader_books/Books/library/mindmaps/
```
...
*读书搭子工具箱 v1.0 - 持续完善中*��子工具箱 v1.0 - 持续完善中*��子工具箱 v1.0 - 持续完善中*